...
# XXD Panel 165｜كولاج يكشف المشهد عبر شق ورقي مركزي
...
ثمانية نماذج أولية من Panel 165، وُلّد كل منها مستقلاً من صورة مصدر مختلفة مع نص إنجليزي قصير. الأفقي: 1536×864 بنصفين متساويين يميناً ويساراً؛ العمودي: 1152×1536 بنصفين متساويين أعلى وأسفل.

رُوجع التمزق العمودي المركزي والحواف الليفية وطبقات الكولاج في كل نموذج. بعض الألوان داكنة وتفاصيل المشهد زائدة والسيارة ما زالت واقعية نسبياً. هذه نتائج فعلية وليست إقراراً باجتياز الجميع مراجعة الأسلوب.
...
شق ورقي رأسي مركزي هو العنصر الأساسي، يكشف موضوعاً معاد البناء بكتل هندسية وطبقات وألياف وظلال ناعمة.
...
- `design-only`: تعرض اللوحة الكاملة ترجمة Panel 165 التصميمية فقط، وتبقى الصورة مرجعاً غير ظاهر.
...
بعد التثبيت أعد تشغيل جلسة Agent ثم استدعِ `$xxd-panel-165`. ويمكن إضافة `--global --agent codex --yes` للتثبيت على مستوى المستخدم.

```text
/xxd-panel-165 photo.jpg --mode top-bottom --size 3:4 --text prompt --locale ar-SA
...
راجع [SKILL.md](SKILL.md) لعقد التشغيل الكامل، ومهايئ التشغيل [بالإنجليزية](references/xxd-panel-165-prompt.en.md) أو [بالصينية](references/xxd-panel-165-prompt.zh-CN.md).
